...
```
 ...
 ## for the following, I am intending to change the terms on the gallery based on the feedback given by Yujin.
 https://www.youtube.com/watch?v=_yxdD-ZX-mg
 

Photo editor -> User personalisation
Camera adjustment -> User personalisation
Flashlight alerts
Object marker -> Object sensor

Instruction -> Textual Instruction
illustration of correct input -> Visual Instruction